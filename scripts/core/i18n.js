...
export class I18n {
  ...
  static translations = {
    en: {
      ...
      // Merge Tool
      'merge.pageTitle': 'Merge Images Online - Free Image Combination Tool',
      'merge.metaDescription': 'Free online image merging tool. Combine multiple images into one with customizable layouts. No registration required.',
      'merge.keywords': 'merge images, combine images, image merger, online merge tool, photo collage',
      'merge.title': 'Merge Images',
      'merge.description': 'Combine multiple images into one with customizable layouts',
      'merge.settingsTitle': 'Merge Settings',
      'merge.addImages': 'Add images to merge',
      'merge.imagesToMerge': 'Images to Merge',
      'merge.noImagesAdded': 'No images added yet',
      ...
      'merge.mergeImages': 'Merge Images',
      'merge.addImagesPreview': 'Add images to see merge preview',
      ...
      // Remove Object Tool
      'removeObject.pageTitle': 'Remove Object Online - Free AI Object Removal Tool',
      'removeObject.metaDescription': 'Free online AI-powered object removal tool. Remove unwanted objects from photos with smart inpainting. No registration required.',
      'removeObject.keywords': 'remove object, object removal, photo editing, AI inpainting, remove people, remove items',
      'removeObject.title': 'Remove Object',
      'removeObject.description': 'Remove unwanted objects from your photos with AI-powered inpainting',
      'removeObject.legalNoticeTitle': 'Legal Notice',
      'removeObject.legalNotice': 'Only remove objects from images you own or have permission to edit.',
      'removeObject.settingsTitle': 'Removal Settings',
      'removeObject.selectImage': 'Select image to edit',
      'removeObject.selectArea': 'Select area to remove',
      'removeObject.brushSize': 'Brush Size',
      'removeObject.inpaintMethod': 'Inpaint Method',
      'removeObject.telea': 'Telea (Fast)',
      'removeObject.navierStokes': 'Navier-Stokes (Quality)',
      'removeObject.simple': 'Simple (Basic)',
      'removeObject.clearSelection': 'Clear Selection',
      'removeObject.inpaint': 'Remove Object',
      'removeObject.uploadPrompt': 'Upload an image to start removing objects',
      'removeObject.preview': 'Preview',
      
      // Black Image Tool
      'blackImage.pageTitle': 'Create Black Image Online - Free Solid Color Image Generator',
      'blackImage.metaDescription': 'Free online black image generator. Create solid black images with custom dimensions. Multiple formats supported.',
      'blackImage.keywords': 'black image, solid color image, create image, image generator, blank image',
      'blackImage.title': 'Create Black Image',
      'blackImage.description': 'Create a solid black image with custom dimensions',
      'blackImage.settingsTitle': 'Image Settings',
      ...
      'blackImage.png': 'PNG',
      'blackImage.jpg': 'JPG',
      'blackImage.webp': 'WebP',
      'blackImage.bmp': 'BMP',
      'blackImage.commonSizes': 'Common Sizes',
      'blackImage.size1920x1080': '1920×1080',
      'blackImage.size1280x720': '1280×720',
      'blackImage.size800x600': '800×600',
      'blackImage.size640x480': '640×480',
      'blackImage.dimensions': 'Dimensions',
      'blackImage.uploadPrompt': 'Click "Create Image" to generate a black image',
      
      // Compress Tool
      'compress.pageTitle': 'Compress Image Online - Free Image Compression Tool',
      'compress.metaDescription': 'Free online image compression tool. Reduce image file size while maintaining quality. Batch processing supported.',
      'compress.keywords': 'compress image, image compression, reduce file size, optimize image, photo compressor',
      'compress.title': 'Compress Image',
      'compress.description': 'Reduce image file size while maintaining quality',
      'compress.settingsTitle': 'Compression Settings',
      ...
      'compress.png': 'PNG',
      'compress.webp': 'WebP',
      'compress.compressImage': 'Compress Image',
      'compress.original': 'Original',
      'compress.compressed': 'Compressed',
      'compress.compressedPrompt': 'Compressed image will appear here',
      ...
      'compress.uploadPrompt': 'Upload an image to compress',
      
      // Resize Tool
      'resize.pageTitle': 'Resize Image Online - Free Image Resizing Tool',
      'resize.metaDescription': 'Free online image resizing tool. Change image dimensions with aspect ratio control. Multiple formats supported.',
      'resize.keywords': 'resize image, image resizer, change image size, resize photo, image dimensions',
      'resize.title': 'Resize Image',
      'resize.description': 'Change image dimensions with aspect ratio control',
      'resize.settingsTitle': 'Resize Settings',
      'resize.width': 'Width (px)',
      'resize.height': 'Height (px)',
      'resize.maintainAspectRatio': 'Maintain Aspect Ratio',
      'resize.resizeMode': 'Resize Mode',
      'resize.pixels': 'Pixels',
      'resize.percentage': 'Percentage',
      'resize.auto': 'Auto',
      'resize.lockAspectRatio': 'Lock aspect ratio',
      'resize.scale': 'Scale (%)',
      'resize.outputFormat': 'Output Format',
      'resize.png': 'PNG',
      'resize.jpeg': 'JPEG',
      'resize.webp': 'WebP',
      'resize.applyResize': 'Apply Resize',
      'resize.originalSize': 'Original Size',
      'resize.resizedSize': 'Resized Size',
      'resize.dimensions': 'Dimensions',
      'resize.uploadPrompt': 'Upload an image to resize',
      
      // Footer
      'footer.aboutTitle': 'About Free Image Tools',
      'footer.aboutDescription': 'Professional online image processing tools that work entirely in your browser. No registration required, complete privacy guaranteed.',
      'footer.twitter': 'Twitter',
      'footer.github': 'GitHub',
      'footer.toolsTitle': 'Tools',
      'footer.cropImage': 'Crop Image',
      'footer.mergeImages': 'Merge Images',
      'footer.removeObject': 'Remove Object',
      'footer.blackImage': 'Black Image',
      'footer.compressImage': 'Compress Image',
      'footer.resizeImage': 'Resize Image',
      ...
      'footer.email': 'Email:',
      'footer.responseTime': 'Response Time:',
      'footer.within24Hours': 'Within 24 hours',
      'footer.copyright': '© {year} Free Image Tools Online. All rights reserved.',
    ...
    zh: {
      ...
      // Merge Tool
      'merge.pageTitle': '在线合并图片 - 免费图片组合工具',
      'merge.metaDescription': '免费在线图片合并工具。将多张图片合并为一张，支持自定义布局。无需注册。',
      'merge.keywords': '合并图片, 组合图片, 图片合并器, 在线合并工具, 照片拼贴',
      'merge.title': '合并图片',
      'merge.description': '将多张图片合并为一张，支持自定义布局',
      'merge.settingsTitle': '合并设置',
      'merge.addImages': '添加要合并的图片',
      'merge.imagesToMerge': '要合并的图片',
      'merge.noImagesAdded': '尚未添加图片',
      'merge.addImage': '添加图片',
      'merge.direction': '方向',
      'merge.horizontal': '横向',
      'merge.vertical': '纵向',
      ...
      'merge.clearAll': '清空全部',
      'merge.mergeImages': '合并图片',
      'merge.addImagesPreview': '添加图片查看合并预览',
      'merge.alignment': '对齐',
      'merge.top': '顶部',
      'merge.center': '居中',
      'merge.bottom': '底部',
      ...
      // Remove Object Tool
      'removeObject.pageTitle': '在线移除对象 - 免费AI对象移除工具',
      'removeObject.metaDescription': '免费在线AI对象移除工具。使用智能修复技术从照片中移除不需要的对象。无需注册。',
      'removeObject.keywords': '移除对象, 对象移除, 照片编辑, AI修复, 移除人物, 移除物品',
      'removeObject.title': '移除对象',
      'removeObject.description': '使用AI智能修复技术从照片中移除不需要的对象',
      'removeObject.legalNoticeTitle': '法律声明',
      'removeObject.legalNotice': '只能从您拥有或有权编辑的图片中移除对象。',
      'removeObject.settingsTitle': '移除设置',
      'removeObject.selectImage': '选择要编辑的图片',
      'removeObject.selectArea': '选择要移除的区域',
      'removeObject.brushSize': '画笔大小',
      'removeObject.inpaintMethod': '修复方法',
      'removeObject.telea': 'Telea (快速)',
      'removeObject.navierStokes': 'Navier-Stokes (质量)',
      'removeObject.simple': 'Simple (基础)',
      'removeObject.clearSelection': '清除选择',
      'removeObject.inpaint': '移除对象',
      'removeObject.uploadPrompt': '上传图片开始移除对象',
      'removeObject.preview': '预览',
      
      // Black Image Tool
      'blackImage.pageTitle': '在线创建纯黑图片 - 免费纯色图片生成器',
      'blackImage.metaDescription': '免费在线纯黑图片生成器。创建指定尺寸的纯黑图片。支持多种格式。',
      'blackImage.keywords': '纯黑图片, 纯色图片, 创建图片, 图片生成器, 空白图片',
      'blackImage.title': '创建纯黑图片',
      'blackImage.description': '创建指定尺寸的纯黑图片',
      'blackImage.settingsTitle': '图片设置',
      ...
      'blackImage.webp': 'WebP',
      'blackImage.bmp': 'BMP',
      'blackImage.commonSizes': '常用尺寸',
      'blackImage.size1920x1080': '1920×1080',
      'blackImage.size1280x720': '1280×720',
      'blackImage.size800x600': '800×600',
      'blackImage.size640x480': '640×480',
      'blackImage.dimensions': '尺寸',
      'blackImage.uploadPrompt': '点击"创建图片"生成纯黑图片',
      
      // Compress Tool
      'compress.pageTitle': '在线压缩图片 - 免费图片压缩工具',
      'compress.metaDescription': '免费在线图片压缩工具。在保持质量的同时减小图片文件大小。支持批量处理。',
      'compress.keywords': '压缩图片, 图片压缩, 减小文件大小, 优化图片, 照片压缩器',
      'compress.title': '压缩图片',
      'compress.description': '在保持质量的同时减小图片文件大小',
      'compress.settingsTitle': '压缩设置',
      'compress.quality': '质量',
      ...
      'compress.png': 'PNG',
      'compress.webp': 'WebP',
      'compress.compressImage': '压缩图片',
      'compress.original': '原始',
      'compress.compressed': '压缩后',
      'compress.compressedPrompt': '压缩后的图片将显示在这里',
      'compress.noLimit': '无限制',
      'compress.originalSize': '原始大小',
      'compress.compressedSize': '压缩后大小',
      'compress.savings': '节省空间',
      'compress.compare': '比较',
      'compress.uploadPrompt': '上传图片进行压缩',
      
      // Resize Tool
      'resize.pageTitle': '在线调整图片大小 - 免费图片调整工具',
      'resize.metaDescription': '免费在线图片调整工具。更改图片尺寸，支持宽高比控制。支持多种格式。',
      'resize.keywords': '调整图片大小, 图片调整器, 更改图片尺寸, 调整照片, 图片尺寸',
      'resize.title': '调整图片大小',
      'resize.description': '更改图片尺寸，支持宽高比控制',
      'resize.settingsTitle': '调整设置',
      'resize.width': '宽度 (像素)',
      'resize.height': '高度 (像素)',
      'resize.maintainAspectRatio': '保持宽高比',
      'resize.resizeMode': '调整模式',
      'resize.pixels': '像素',
      'resize.percentage': '百分比',
      'resize.auto': '自动',
      'resize.lockAspectRatio': '锁定宽高比',
      'resize.scale': '缩放 (%)',
      'resize.outputFormat': '输出格式',
      'resize.png': 'PNG',
      'resize.jpeg': 'JPEG',
      'resize.webp': 'WebP',
      'resize.applyResize': '应用调整',
      'resize.originalSize': '原始尺寸',
      'resize.resizedSize': '调整后尺寸',
      'resize.dimensions': '尺寸',
      'resize.uploadPrompt': '上传图片进行调整',
      
      // Footer
      'footer.aboutTitle': '关于免费图片工具',
      'footer.aboutDescription': '专业的在线图片处理工具，完全在您的浏览器中运行。无需注册，完全保护隐私。',
      'footer.twitter': 'Twitter',
      'footer.github': 'GitHub',
      'footer.toolsTitle': '工具',
      'footer.cropImage': '裁剪图片',
      'footer.mergeImages': '合并图片',
      'footer.removeObject': '移除对象',
      'footer.blackImage': '纯黑图片',
      'footer.compressImage': '压缩图片',
      'footer.resizeImage': '调整大小',
      ...
      'footer.email': '邮箱：',
      'footer.responseTime': '响应时间：',
      'footer.within24Hours': '24小时内',
      'footer.copyright': '© {year} 免费图片工具在线。保留所有权利。',
      'footer.privacy': '隐私',
  ...
  static updatePage() {
    ...
    document.querySelectorAll('[data-i18n]').forEach(element => {
      ...
      // Handle dynamic year replacement for copyright
      if (key === 'footer.copyright' && element.hasAttribute('data-year')) {
